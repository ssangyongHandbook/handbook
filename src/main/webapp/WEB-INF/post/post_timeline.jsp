                  ...
                  setTimeout(function(){
                     ...
                     if (dto.post_file != 'no') {
                        ...
                        if (dto.user_num != "${sessionScope.user_num}" && dto.checkfollowing != 1){
                           s += "<span class='follow' id='follow" + dto.post_num + "' followpost_num='follow" + dto.post_num + "' unfollowpost_num='unfollow" + dto.post_num + "' from_user='${sessionScope.user_num}' to_user='" + dto.user_num + "'>팔로우하기</span> ";
                            s += "<span class='unfollow' id='unfollow" + dto.post_num + "' followpost_num='follow" + dto.post_num + "' unfollowpost_num='unfollow" + dto.post_num + "' style='display:none;' from_user='${sessionScope.user_num}' to_user='" + dto.user_num + "' >팔로우 끊기</span> ";
                        }
                        
                        if (dto.user_num != "${sessionScope.user_num}" && dto.checkfollowing == 1) {
                            s += "<span class='unfollow' id='unfollow" + dto.post_num + "' followpost_num='follow" + dto.post_num + "' unfollowpost_num='unfollow" + dto.post_num + "' from_user='${sessionScope.user_num}' to_user='" + dto.user_num + "'>팔로우 끊기</span> ";
                            s += "<span class='follow' id='follow" + dto.post_num + "' followpost_num='follow" + dto.post_num + "' unfollowpost_num='unfollow" + dto.post_num + "' from_user='${sessionScope.user_num}' to_user='" + dto.user_num + "' style='display:none;'>팔로우 하기</span> ";
                        }
      ...
      $.ajax({
         ...
         success : function(res) {
            ...
            $.each(res, function(i, item) {
               ...
               s += '<button type="button" class="cminsert" comment_num="'+item.comment_num+'" post_num="'+item.post_num+'"  style="margin-right: 20px;">답글입력</button>';
               s += '</div>';
               s += '</form></div>';
               console.log(s);
